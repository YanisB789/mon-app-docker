...
2. Vérifier les [Issues GitHub](https://github.com/votre-username/mon-app-docker/issues)
3. Créer une nouvelle issue si nécessaire

---

**Note** : Cette documentation correspond au projet de conteneurisation dans le cadre du cours Docker/DevOps. L'application démontre une maîtrise complète de Docker, Docker Compose, et des bonnes pratiques de conteneurisation.
